...
reduced_df = pd.read_csv('/home/kofi/filetransfer/Reduced_df.csv')
reduced_df
...
df = df_sample
df.to_csv('/home/kofi/filetransfer/testsample.csv', index=False)
df
...
df.to_csv('/home/kofi/filetransfer/Reduced_localsample_df.csv')
df
...
df.to_csv('/home/kofi/filetransfer/Reduced_localsample_df_Evaluated.csv', index=False)
df